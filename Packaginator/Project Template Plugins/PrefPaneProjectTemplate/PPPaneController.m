...
@implementation PPPaneController
...
- (IBAction) add:(id) sender
{
    ...
    [tOpenPanel beginSheetForDirectory:nil
                                  file:nil
                                 types:[NSArray arrayWithObject:@"prefPane"]
            ...
            if (tArray!=nil)
            {
               NSString * tDraggedPath;
                ...
                for(i=0;i<tCount;i++)
                {
                    ...
                    if ([[tDraggedPath pathExtension] isEqualToString:@"prefPane"]==NO)
                    {
                        break;
                    }
...
- (void) processWithEngine:(id) inEngine
{
    ...
    if (tCount>0)
    {
        ...
        tDictionary=[PBProjectDictionaryManager fileObjectAtPath:@"/Library/PreferencePanes" forPackageProject:tProjectDictionary];
